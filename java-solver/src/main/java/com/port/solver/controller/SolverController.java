...
public class SolverController {
    ...
    private final Map<String, Object> solverState = new ConcurrentHashMap<>();
    ...
    public ResponseEntity<Map<String, Object>> getSolutionData() {
        ...
        for (Vessel v : problem.getVessels()) vesselMap.put(v.getName(), v);
    ...
    private void runSolverThread(Map<String, Object> config) {
        ...
        try {
            ...
            if (settings instanceof Map) {
                ...
                if (tl != null) timeLimit = ((Number) tl).intValue();
            }
    ...
    private Problem configToProblem(Map<String, Object> config) {
        ...
        List<Map<String, Object>> yzConfigs = (List<Map<String, Object>>) config.getOrDefault("yard_quay_zones", List.of());
        ...
        for (Map<String, Object> vc : vesselConfigs) {
            ...
            List<Map<String, Object>> tzConfigs = (List<Map<String, Object>>) vc.getOrDefault("target_zones", List.of());
            ...
            int arrHourOffset = vc.containsKey("arrival_hour_offset") ?
                    ((Number) vc.get("arrival_hour_offset")).intValue() : 0;
        ...
        List<Map<String, Object>> unavailConfigs = (List<Map<String, Object>>) config.getOrDefault("crane_unavailability", List.of());
        ...
        List<Map<String, Object>> fzConfigs = (List<Map<String, Object>>) config.getOrDefault("forbidden_zones", List.of());
    ...
    private Map<String, Object> getDefaultConfig() {
        ...
        config.put("forbidden_zones", List.of(
                Map.of("start_berth_position", 400, "end_berth_position", 600,
                        "start_shift", 2, "end_shift", 4, "description", "Quay Wall Maintenance A"),
                Map.of("start_berth_position", 1500, "end_berth_position", 1600,
                        "start_shift", 6, "end_shift", 8, "description", "Dredging Operations B")
        ));
